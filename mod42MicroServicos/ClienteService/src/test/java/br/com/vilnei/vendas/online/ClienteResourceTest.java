package br.com.vilnei.vendas.online;
...
import br.com.vilnei.vendas.online.reources.ClienteResource;
import br.com.vilnei.vendas.online.usecase.BuscaCliente;
import br.com.vilnei.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("Vilnei 1").build();
